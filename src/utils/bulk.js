...
export const setBulkStatus = async (data) => {
  let apiResponse;
  ...
  try {
    ...
    if (apiResponse && apiResponse.data) {
      ...
      if (!apiResponseData.isError) {
        toaster.success(apiResponseData.message || data.success || "Status updated successfully");
        ...
        toaster.error(apiResponseData.message || data.error || "Status not updated");
    }
  }
  catch {
...
export const deleteBulkItems = async (data) => {
  let apiResponse;
  ...
  try {
    ...
    if (apiResponse && apiResponse.data) {
      ...
      if (!apiResponseData.isError) {
        toaster.success(apiResponseData.message || data.success || "Deleted successfully");
        ...
        toaster.error(apiResponseData.message || data.error || "Not deleted");
    }
  }
  catch {
    console.log("Something went wrong.");
